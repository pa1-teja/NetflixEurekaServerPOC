...
import com.example.vehiclesapi.Client.Maps.MapsClient;
import com.example.vehiclesapi.Client.Prices.PriceClient;
import com.example.vehiclesapi.Domain.Car.Car;
import com.example.vehiclesapi.Domain.Car.CarRepository;
...
public class CarService {
    ...
    public Car findById(Long id){
        ...
        if (car.isPresent()){
            Car car1 = car.get();
            car1.setLocation(mapsClient.getAddress(new Location(1.0, 1.0)));
            car1.setPrice(priceClient.getPrice(id));
            return car1;
        } else {
